            ...
            if (people) {
                for (let i = 0, l = people.length; i < l; i++) {
                    rows += `<tr>
                                ...
                                <td><a href="https://h8ocbc-deployment-012.herokuapp.com/${people[i].person_id}"><button>Notes</button></a></td>
                            </tr>`;
                }
...
ns.controller = (function (m, v) {
    ...
    $('#update').click(function (e) {
        ...
        if (validate(fname, lname) && validateId(person_id)) {
    ...
    $('table > tbody').on('dblclick', 'tr', function (e) {
        ...
        lname = $target
            ...
            .find('td.lname')
            .text();
        console.log(person_id, fname, lname);
